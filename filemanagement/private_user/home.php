...
<head>
  ...
  <title>Dashboard of Student/User</title>
  <!-- Font Awesome -->
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <img src="img/newlearn.png" class="rounded" alt="..."><hr>
    <div class="">
     
     <div class=""><p><b style="font-size: 1.1em">Status:</b> Online</p></div>
     <div class=""><p><b style="font-size: 1.1em">Position:</b> User/Student</p></div>

  </div>
  <hr>
  </div>
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
   <h6 style="font-size: 1.1em">School File Management System (SFMS)</h6><Hr>
  is used for file maintenance (or management) operations. It is is a type of web page site that manages data files in a computer system. A school file management system has limited capabilities and is designed to manage individual or group files, such as the electronic documents and records.</div>
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><h6 style="font-size: 1.1em">。。。。。。。。。。。。。。</h6><Hr><br><div class=""><p><b style="font-size: 1.1em">Currently:</b> Exploring</p></div><p><b style="font-size: 1.1em">University : </b>Wawasan </p>
</div><hr><br>
<!--   <div class="card">
