  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <img src="img/aiart2.jpg" width="150px" height="200px;" class="img-fluid" alt="">
      </a>
        ...
        <a href="#" class="list-group-item list-group-item-action waves-effect" data-toggle="modal" data-target="#modalRegisterForm2">
          <i class="fas fa-user mr-3"></i>Add Student/User</a>
        ...
        <a href="view_userfile.php" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-folder-open"></i> View Admin File</a>
...
<!--end modaladmin-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
           <div class="md-form mb-5">
          <input type="hidden" id="orangeForm-name" name="status" value = "Student" class="form-control validate" required="">
        </div>
        <div class="md-form mb-5">
          <i class="fas fa-user prefix grey-text"></i>
...
?>
    ...
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <div class="md-form mb-5">
          ...
          <label data-error="wrong" data-success="right" for="orangeForm-name">User/Student name</label>
        </div>
        <div class="md-form mb-5">
          <i class="fas fa-envelope prefix grey-text"></i>
          <input type="email" id="orangeForm-email" name="email_address" value="<?php echo $admin1;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-email">User/Student email</label>
        </div>

        <div class="md-form mb-4">
          <i class="fas fa-lock prefix grey-text"></i>
          <input type="password" id="orangeForm-pass" name="user_password" value="<?php echo $pass1;?>" class="form-control validate">
          <label data-error="wrong" data-success="right" for="orangeForm-pass">User/Student password</label>
        </div>
       <div class="md-form mb-4">
          <i class="fas fa-user prefix grey-text"></i>
 ...
 if(isset($_POST['edit'])){
  ...
  echo "<script type = 'text/javascript'>alert('Success Edit Student/User!!!');document.location='view_user.php'</script>";
