...
<!--end modaladmin-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold"><i class="fas fa-user-plus"></i> Add Student/User</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
?>
 ...
 if(isset($_POST['edit2'])){
  ...
  echo "<script type = 'text/javascript'>alert('Success Edit Admin/Employee!!!');document.location='view_admin.php'</script>";
