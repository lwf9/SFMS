...
<head>
  ...
  <title>Dashboard of School File Management System</title>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-4">
         ...
         <div class="md-form mb-4">
          <i class="fas fa-user prefix grey-text"></i>
          <input type="text" id="orangeForm-pass" name="user_status" value = "Student" class="form-control validate" readonly="">
          <label data-error="wrong" data-success="right" for="orangeForm-pass">User Status</label>
        </div>
      </div>
      <div class="modal-footer d-flex justify-content-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
                    ...
                    ?>
                <CENTER><h3 class="page-header" > <b>Count Per Upload File of an Admin</b> </h3></CENTER>  
